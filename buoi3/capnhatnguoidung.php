...
<body>
    ...
    <div class="container">
        ...
        <select name="vai_tro_id">
            ...
            <option value="2" <?php if($nguoidung['vai_tro_id']==2) echo "selected"; ?>>User</option>
            <option value="3" <?php if($nguoidung['vai_tro_id']==3) echo "selected"; ?>>Đạo diễn</option>
            <option value="4" <?php if($nguoidung['vai_tro_id']==4) echo "selected"; ?>>Diễn viên</option>
        </select>
        ...
        <?php
            ...
            $sql = "UPDATE nguoi_dung
             SET ten_dang_nhap='$tenDn',`ho_ten`='$hoTen',`email`='$email',`ngay_sinh`='$ngaysinh',`sdt`='$sdt',
             `vai_tro_id`='$vai_tro_id',`mat_khau`='$pwd' WHERE id = $id ";
